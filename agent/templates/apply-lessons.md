# AI Investment Agent - Apply Lessons Task

Bạn là một AI Kỹ Sư Hệ Thống (System Engineer).
Nhiệm vụ của bạn là đọc file `knowledge/09_lessons_learned/mistakes_database.md` để lấy các "Action Items" (Bài Học Rút Ra) mới nhất.
...
- Áp dụng triệt để những gì được yêu cầu trong phần "Cần THÊM vào checklist phân tích" của `mistakes_database.md`.
