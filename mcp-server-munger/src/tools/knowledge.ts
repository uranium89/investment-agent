  ...
  return [
    {
      name: "munger_list",
      description:
        "List all available Charlie Munger investment knowledge files. " +
...

    {
      name: "munger_read",
      description:
        "Read a specific Charlie Munger investment knowledge file. " +
...

    {
      ...
      description:
        "Get the complete Charlie Munger analysis framework for analyzing a Vietnamese stock. " +
...

    {
      ...
      description:
        "Get Charlie Munger's mental models for a specific discipline. " +
      ...
      inputSchema: {
        discipline: z
          ...
          .describe(
            "Which discipline's mental models to retrieve. Use 'all' for overview.",
          ),
      },
      handler: async (args: { discipline: string }) => {
        ...
        if (!file) {
          return {
            content: [{ type: "text" as const, text: `Unknown discipline: ${args.discipline}` }],
          };
        }
...

    {
      ...
      description:
        "Get Charlie Munger's complete investment checklist and mistake-avoidance framework. " +
